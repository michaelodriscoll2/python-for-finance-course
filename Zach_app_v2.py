...
#V2 Main Changes:#
#--------------------------------------------------------------------------#
#added company name display when ticker is entered
#made page configuration to wide and added page title and subheaders
#added interactive sliders for days to show and moving average length
#formatted return outputs to percentages for better readability
