...
st.write(f"Expected Annual Return of Optimized Portfolio: {optimal_portfolio_returns:.4f}")
st.write(f"Expected Volatility of Optimized Portfolio: {optimal_portfolio_volatility:.4f}")
